...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x33, 0x89, 0x27, 0x6f, 0xbb, 0xbb, 0x1e, 0x45, 0x80, 0xc3, 0x7d, 0xaf, 0x9f, 0x3e, 0x76, 0xaa}
...
#define IMAI_DATA_OUT_SYMBOLS {"unlabelled", "click", "right", "left"}
